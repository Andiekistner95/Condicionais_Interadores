...
public class Classe {
	public static void main(String[] args) {
		...
		System.out.println("Quais as condições do tempo?");
		...
		case "Nublado":
			if (temperatura > 25) {
				...
				System.out.println("Ela usará calça de moletom e sobretudo");
			}
			break;
		...
		case "Chovendo":
			if (temperatura <= 10) {
				...
				System.out.println("Ela usará uma blusa regata");
			}
			break;

		default:
			System.out.println("Ela vai ficar em casa");
			break;
		}
	}
}
